...
var RecaptchaInput = (function (_React$Component) {
  _inherits(RecaptchaInput, _React$Component);

  function RecaptchaInput(props) {
    _classCallCheck(this, RecaptchaInput);

    _get(Object.getPrototypeOf(RecaptchaInput.prototype), 'constructor', this).call(this, props);
  ...
  _createClass(RecaptchaInput, [{
    ...
    value: function render() {
      return React.createElement(
        'div',
        { id: this.props.name },
        React.createElement(_reactGoogleRecaptcha2['default'], { ref: recaptchaRef, sitekey: this.props.placeholder, onChange: this.handleChange.bind(this) })
      );
    }
  }]);
